  ...
  return (
    ...
    <div className='md:h-40 h-auto py-8 md:py-0 m-auto w-full xl:w-9/12 lg:w-10/12 border-[1px] bg-color_hueso mt-20 rounded-xl text-xs md:text-base'>
        <ul className='flex md:flex-row flex-col justify-around items-center h-full space-y-10 md:space-y-0'>
            <li className='flex flex-col justify-evenly items-center font-bold hover:scale-105'><GiTomato className='h-auto w-12 rounded-full text-white p-3 bg-color_naranja mb-3'/>Ingredientes frescos</li>
            <li className='flex flex-col justify-evenly items-center font-bold hover:scale-105'><MdOutlineDeliveryDining className='h-auto w-12 rounded-full text-white p-3 bg-color_naranja mb-3'/>Entrega rapida</li>
            <li className='flex flex-col justify-evenly items-center font-bold hover:scale-105'><TbMeat className='h-auto w-12 rounded-full text-white p-3 bg-color_naranja mb-3'/>Carne de alta calidad</li>
        </ul>
    </div>
    </>
  )
